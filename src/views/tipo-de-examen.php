            ...
            <div class="w3-content w3-padding-32">
                ...
                <div class="w3-row">
                    <div class="w3-col l2 w3-right">
                        ...
                        <select class="w3-select w3-border w3-white" name="orderBy" id="tipoExamenSortItem">
                ...
                <div class="w3-responsive w3-padding-top-24">
                    <table id="tipoExamenTable" class="w3-table w3-bordered w3-white">
                ...
                <div class="w3-section">
                    ...
                    <div id="modalBody">
                        <form id="tipoExamenForm">
                            <input type="hidden" id="tipo-examen-id" name="tipo-examen-id" value="">
                            <div class="w3-row w3-padding-8">
                                <div class="w3-half">
                                    <label for="tipo-examen-name">Nombre</label>
                                    <input type="text" id="tipo-examen-name" name="tipo-examen-name"
                                        class="w3-input w3-border">
                                </div>
                            </div>
                            <div class="w3-row w3-padding-8">
                                <div class="w3-col l12">
                                    <label for="tipo-examen-description">Descripción</label>
                                    <input type="text" id="tipo-examen-description" name="tipo-examen-description"
                                        class="w3-input w3-border">
                                </div>
                            </div>
