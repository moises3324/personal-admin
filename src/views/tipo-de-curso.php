        ...
        <div class="w3-content w3-padding-32">
            ...
            <div class="w3-row">
                <div class="w3-col l2 w3-right">
                    ...
                    <select class="w3-select w3-border w3-white" name="orderBy" id="tipoCursoSortItem">
            ...
            <div class="w3-responsive w3-padding-top-24">
                <table id="tipoCursoTable" class="w3-table w3-bordered w3-white">
    ...
    <div class="w3-modal-content w3-card-4">
        <div class="w3-container">
            <div class="w3-section">
                <div id="modalBody">
                    <form id="tipoCursoForm">
                        <input type="hidden" id="tipo-curso-id" name="tipo-curso-id" value="">
                        <div class="w3-row w3-padding-8">
                            <div class="w3-half">
                                <label for="tipo-curso-name">Nombre</label>
                                <input type="text" id="tipo-curso-name"
                                       name="tipo-curso-name"
                                       class="w3-input w3-border">
                            </div>
                        </div>
                        <div class="w3-row w3-padding-8">
                            <div class="w3-col l12">
                                <label for="tipo-curso-description">Descripción</label>
                                <input type="text" id="tipo-curso-description"
                                       name="tipo-curso-description"
                                       class="w3-input w3-border">
                            </div>
                        </div>
...
<script src="../scripts/tipo_curso_functions.js"></script>
</body>
</html>
