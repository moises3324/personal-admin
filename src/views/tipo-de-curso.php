...
<body>
                        ...
                        <form id="tipoCursoForm">
                            ...
                            <div class="w3-row w3-padding-8">
                                <div class="w3-half">
                                    ...
                                    <input type="text" id="tipo-curso-name" name="tipo-curso-name"
                            ...
                            <div class="w3-row w3-padding-8">
                                <div class="w3-col l12">
                                    ...
                                    <input type="text" id="tipo-curso-description" name="tipo-curso-description"
                                        class="w3-input w3-border">
                                </div>
                            </div>
    ...
    <script src="../scripts/tipo_curso.js"></script>
</body>
