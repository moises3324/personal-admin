            ...
            <div class="w3-content w3-padding-32">
                ...
                <div class="w3-row">
                    <div class="w3-col l2 w3-right">
                        ...
                        <select class="w3-select w3-border w3-white" name="orderBy" id="centroCostoSortItem">
                ...
                <div class="w3-responsive w3-padding-top-24">
                    <table id="centroCostoTable" class="w3-table w3-bordered w3-white">
                        ...
                        <form id="centroCostoForm">
                            ...
                            <div class="w3-row w3-padding-8">
                                <div class="w3-half">
                                    ...
                                    <input type="text" id="centro-costo-name" name="centro-costo-name"
                                        class="w3-input w3-border" required>
                                </div>
                                <div class="w3-row">
                                    <small id="errorName" class="w3-red w3-hide">Este campo no puede quedar
                                        vacio</small>
                                </div>
                            </div>
                            <div class="w3-row w3-padding-8">
                                <div class="w3-col l12">
                                    <label for="centro-costo-description">Descripción</label>
                                    <input type="text" id="centro-costo-description" name="centro-costo-description"
