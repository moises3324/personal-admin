...
>
    <div class="container" id="container-centro-costo">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="centro-costo-form">
                    ...
                    <div class="py-1">
                        <label for="centro-costo-description">Descripcion</label>
                        <input type="text" id="centro-costo-description" class="form-control"
